...
window.addEventListener('load',()=>{
    ...
    //     }
    // });
    // tl4.to('.first-slider-row ',{xPercent:-100, duration:15})

    // let scroller = document.querySelector('.first-slider-row')
    // let slides = gsap.utils.toArray('.first-slider-row  .slide-column')
